...
/**
 * Z zmiennych defult jest liczona maksymalna tablica generowania wykresów do sortowania
 *
 */
public class SortArray extends JPanel {
    ...
    private void finaliseUpdate(int value,  long millisecondDelay, boolean isStep) {
        ...
        try {
            /**
             * Operowanie na wątku w ramach opóznienia
             */
    ...
    public void paintComponent(Graphics g) {
		...
		try
		{
			...
			panelGraphics.drawString("Wybrany algorytm: " + algorithmName, 10, 30);
			panelGraphics.drawString("Opóźnienie: " + algorithmDelay + "ms", 10, 55);
			panelGraphics.drawString("Ilość zmian w tablicy: " + arrayChanges, 10, 80);
            panelGraphics.drawString("Rozmiar tablicy: " + NUM_BARS, 10, 100);
